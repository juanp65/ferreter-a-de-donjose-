...
urlpatterns = [
    ...
    path('login/', views.InicioSesionView.as_view(), name='login'),
    path('registro/', views.registro, name='registro'),
    path('cuenta/', views.cuenta, name='cuenta'),
    path('logout/', auth_views.LogoutView.as_view(), name='logout'),

    path('panel/', views.dashboard, name='dashboard'),
    path('panel/productos/nuevo/', views.producto_crear, name='producto_crear'),
    path('panel/productos/<int:producto_id>/editar/', views.producto_editar, name='producto_editar'),
    path('panel/productos/exportar/', views.exportar_productos_csv, name='exportar_productos_csv'),
    path('panel/pedidos/', views.pedidos_panel, name='pedidos_panel'),
    path('panel/pedidos/<int:pedido_id>/estado/', views.cambiar_estado_pedido, name='cambiar_estado_pedido'),
]
